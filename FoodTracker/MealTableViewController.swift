...
class MealTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //MARK: Setup for SearchBar
//        searchController.searchBar.delegate = self
        searchController.searchResultsUpdater = self
        searchController.obscuresBackgroundDuringPresentation = false
        searchController.searchBar.placeholder = "Search Meal in Here!!!"
...
//        let cellIdentifier = "MealTableViewCell"
    ...
    */
    ...
    private func loadSampleMeal() {
        ...
        guard let meal1 = Meal(name: "Uni", photo: photo1, rating: 5) else {
            fatalError("Unable to instantiate meal1")
        }
        guard let meal2 = Meal(name: "Havi", photo: photo2, rating: 5) else {
            fatalError("Unable to instantiate meal2")
        }
        guard let meal3 = Meal(name: "Nude", photo: photo3, rating: 5) else {
